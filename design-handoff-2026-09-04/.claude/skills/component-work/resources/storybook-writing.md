...
> **brandName / systemName**: 디자인 시스템 라이브러리 문서는 `Design System` / `Starter Kit`,
> BeautyMaster 대시보드 문서(`Overview/BeautyMaster/*`, `Style/*`)는 `BeautyMaster` / `Influencer Dashboard`를 쓴다.
