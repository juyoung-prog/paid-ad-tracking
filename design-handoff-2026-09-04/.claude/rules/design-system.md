...
`text.disabled`는 AA 미달이라 비활성 컨트롤 전용이다. 상태색은 success/warning/error 셋만 쓴다.

#### 타이포그래피
```jsx
// 제목은 시맨틱만 태그로 잡고 크기는 sx로 준다
<Typography component="h2" sx={{ fontSize: 14, fontWeight: 600 }}>섹션 제목</Typography>

// 운영 화면 본문 스케일: 10 · 11 · 12 · 13 · 14px
