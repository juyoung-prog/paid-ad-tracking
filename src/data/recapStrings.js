...
export const RECAP_STRINGS = Object.freeze({
  ...
  'cell.worked.top': { en: '{metric} ranked in the top {pct}% of {scope}.', ko: '{metric}이(가) {scope} 중 상위 {pct}%에 들었습니다.', 'zh-Hant': '{metric} 在{scope}中排進前 {pct}%。' },
  ...
  'cell.improve.bottom': { en: '{metric} ranked in the bottom {pct}% of {scope}.', ko: '{metric}이(가) {scope} 중 하위 {pct}%에 들었습니다.', 'zh-Hant': '{metric} 在{scope}中落入後 {pct}%。' },
  ...
  'cell.keep.reach': { en: 'the reach setup', ko: '도달 설정', 'zh-Hant': '觸及設定' },
  'cell.keep.hook': { en: 'the opening', ko: '오프닝', 'zh-Hant': '開場' },
  'cell.keep.hold': { en: 'the watch-through format', ko: '끝까지 보게 한 형식', 'zh-Hant': '促成完整觀看的形式' },
  'cell.keep.click': { en: 'the click-driving setup', ko: '클릭을 만든 설정', 'zh-Hant': '帶動點擊的設定' },
  'cell.keep.engagement': { en: 'the engagement format', ko: '참여를 만든 형식', 'zh-Hant': '帶動互動的形式' },
  'cell.keep.result': { en: 'the result-driving setup', ko: '결과를 만든 설정', 'zh-Hant': '帶動成果的設定' },
  'cell.test.reach': { en: 'lower CPM', ko: '더 낮은 CPM', 'zh-Hant': '更低的 CPM' },
  'cell.test.click': { en: 'a stronger click response', ko: '더 나은 클릭 반응', 'zh-Hant': '更好的點擊反應' },
  'cell.test.hook': { en: 'more early attention', ko: '더 많은 초반 주목', 'zh-Hant': '更多前段注意力' },
  'cell.test.hold': { en: 'longer watch-through', ko: '더 긴 시청 유지', 'zh-Hant': '更長的觀看時間' },
  'cell.test.engagementRate': { en: 'a higher engagement rate', ko: '더 높은 참여율', 'zh-Hant': '更高的互動率' },
  'cell.test.cpe': { en: 'lower cost per engagement', ko: '더 낮은 참여당 비용', 'zh-Hant': '更低的每次互動成本' },
  'cell.test.result': { en: 'lower cost per result', ko: '더 낮은 결과당 비용', 'zh-Hant': '更低的每個成果成本' },
  'cell.outcome.hold': { en: 'sustained watch-through', ko: '끝까지 시청', 'zh-Hant': '持續觀看' },
  'cell.outcome.engagement': { en: 'engagement', ko: '참여', 'zh-Hant': '互動' },
  'cell.outcome.click': { en: 'clicks', ko: '클릭', 'zh-Hant': '點擊' },
  'cell.outcome.result': { en: 'results', ko: '결과', 'zh-Hant': '成果' },
  'cell.next.hookThen': { en: 'Retest the opening and monitor whether early attention translates into {outcome}.', ko: '오프닝을 다시 시험하고 초반 주목이 {outcome}(으)로 이어지는지 봅니다.', 'zh-Hant': '重新測試開場，並觀察前段注意力是否轉為{outcome}。' },
  'cell.next.reachThen': { en: 'Test whether efficient reach can produce more {outcome} without increasing cost.', ko: '효율적인 도달이 비용을 늘리지 않고 더 많은 {outcome}을(를) 만드는지 시험합니다.', 'zh-Hant': '測試有效率的觸及能否在不增加成本下帶來更多{outcome}。' },
  'cell.next.keepTest': { en: 'Preserve {keep} and test for {test}.', ko: '{keep}은(는) 유지하고 {test}을(를) 시험합니다.', 'zh-Hant': '保留{keep}，並測試{test}。' },
  'cell.next.keepBudget': { en: 'Keep {keep} and plan the next daily budget for the {pct}% overspend.', ko: '{keep}은(는) 유지하고 다음 일예산은 {pct}% 초과 지출을 감안해 정합니다.', 'zh-Hant': '保留{keep}，並依 {pct}% 超支規劃下次每日預算。' },
  'cell.next.repeat': { en: 'Repeat the {goal} format and confirm whether {metric} holds at similar spend.', ko: '{goal} 형식을 반복하고 비슷한 지출에서 {metric}이(가) 유지되는지 확인합니다.', 'zh-Hant': '重複{goal}形式，確認在相近花費下 {metric} 是否維持。' },
  'cell.next.improve': { en: 'Test a change aimed at {test}, using this {metric} as the baseline to beat.', ko: '{test}을(를) 노린 변경을 시험하고, 이번 {metric}을(를) 넘어야 할 기준으로 삼습니다.', 'zh-Hant': '測試以{test}為目標的變更，並以此次 {metric} 作為要超越的基準。' },
