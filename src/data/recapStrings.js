...
export const RECAP_STRINGS = Object.freeze({
  ...
  'recap.table.overall': { en: 'Overall performance', ko: '종합 성과', 'zh-Hant': '整體表現' },
  'recap.table.overallTitle': { en: 'Overall performance', ko: '종합 성과', 'zh-Hant': '整體表現' },
  'recap.table.overallBody': { en: 'One answer to "overall, how did this campaign perform?" — Strong, Average, or Weak.', ko: '"전체적으로 이 캠페인은 어땠나"에 대한 한 단어 답 — Strong · Average · Weak.', 'zh-Hant': '對「整體而言這支廣告表現如何」的一個答案——Strong、Average 或 Weak。' },
  'recap.table.overallBody2': { en: 'The campaign goal decides which metrics matter most: the cost of the goal\'s result first, then video and engagement response. Primary metrics set the rating; secondary metrics can move it one step.', ko: '캠페인 목표가 어떤 지표가 중요한지 정합니다. 목표 결과의 비용이 먼저, 그다음 영상·참여 반응입니다. 대표 지표가 등급을 정하고 보조 지표는 한 단만 움직입니다.', 'zh-Hant': '廣告目標決定哪些指標最重要：先看目標成果的成本，再看影片與互動反應。主要指標決定等級，次要指標最多調整一級。' },
  'recap.table.overallBody3': { en: 'There are no company KPI thresholds, so no fixed cut-offs are used. Each metric is read against comparable past campaigns on the same platform and goal — but no single historical rank decides the rating. When the primary metrics cannot be read, the cell says Insufficient data.', ko: '회사 KPI 기준값이 없어 고정 문턱은 쓰지 않습니다. 각 지표는 같은 플랫폼·목표의 과거 비교 캠페인에 대어 읽지만, 순위 하나가 등급을 정하지는 않습니다. 대표 지표를 읽을 수 없으면 Insufficient data입니다.', 'zh-Hant': '沒有公司 KPI 門檻，因此不使用固定切點。各指標對照同平台、同目標的過往可比廣告解讀，但單一歷史排名不決定等級。無法解讀主要指標時顯示 Insufficient data。' },
  'recap.table.overallRule': { en: 'Rated on {primary} first; {secondary} can move it one step. Read against comparable past campaigns — no fixed thresholds, no single rank.', ko: '{primary}이(가) 등급을 정하고 {secondary}은(는) 한 단만 움직입니다. 과거 비교 캠페인에 대어 읽으며 고정 문턱·단일 순위는 없습니다.', 'zh-Hant': '以 {primary} 定等級，{secondary} 最多調整一級。對照過往可比廣告解讀，無固定門檻、無單一排名。' },
  'recap.table.overallWritten': { en: 'Rated by a person in Edit.', ko: 'Edit에서 사람이 고른 등급입니다.', 'zh-Hant': '由人員在編輯中評定。' },
  'recap.table.overallInsufficient': { en: 'Insufficient data', ko: '데이터 부족', 'zh-Hant': '資料不足' },
  'recap.table.overallInsufficientHint': { en: 'Not enough comparable past campaigns to read this campaign\'s primary metrics ({primary}). The metrics themselves are shown to the right.', ko: '이 캠페인의 대표 지표({primary})를 읽을 만큼 비교 캠페인이 없습니다. 지표 자체는 오른쪽에 보입니다.', 'zh-Hant': '可比的過往廣告不足以解讀此廣告的主要指標（{primary}）。指標本身顯示於右側。' },
  ...
  'recap.table.strengths': { en: 'Strengths', ko: '강점', 'zh-Hant': '優點' },
  'recap.table.improve': { en: 'Areas to improve', ko: '개선점', 'zh-Hant': '待改善' },
  'recap.table.reason': { en: 'Reason', ko: '이유', 'zh-Hant': '原因' },
  'recap.table.autoHint': { en: 'Generated from the same evidence as the rating — comparable past campaigns on this platform and goal. It describes what the data shows, not why it happened.', ko: '등급과 같은 근거(같은 플랫폼·목표의 과거 비교 캠페인)에서 만든 문장입니다. 데이터가 보여주는 것만 말하고 원인은 단정하지 않습니다.', 'zh-Hant': '由與等級相同的證據（同平台、同目標的過往可比廣告）產生。只描述資料顯示的情形，不斷定原因。' },
  'recap.table.writtenHint': { en: 'Written by a person in Edit.', ko: 'Edit에서 사람이 쓴 문장입니다.', 'zh-Hant': '由人員在編輯中撰寫。' },
  'overall.strength.cpm': { en: 'Strong reach efficiency', ko: '도달 효율 강함', 'zh-Hant': '觸及效率強' },
  'overall.strength.hookRate': { en: 'Strong early video attention', ko: '영상 초반 주목 강함', 'zh-Hant': '影片前段注意力強' },
  'overall.strength.holdRate': { en: 'Strong watch-through', ko: '끝까지 시청 강함', 'zh-Hant': '完整觀看強' },
  'overall.strength.ctr': { en: 'High click response', ko: '클릭 반응 높음', 'zh-Hant': '點擊反應高' },
  'overall.strength.cpc': { en: 'Efficient cost per click', ko: '클릭당 비용 효율적', 'zh-Hant': '每次點擊成本有效率' },
  'overall.strength.engagementRate': { en: 'Strong engagement response', ko: '참여 반응 강함', 'zh-Hant': '互動反應強' },
  'overall.strength.cpe': { en: 'Efficient cost per engagement', ko: '참여당 비용 효율적', 'zh-Hant': '每次互動成本有效率' },
  'overall.strength.cpa': { en: 'Efficient cost per result', ko: '결과당 비용 효율적', 'zh-Hant': '每個成果成本有效率' },
  'overall.weak.cpm': { en: 'High reach cost', ko: '도달 비용 높음', 'zh-Hant': '觸及成本高' },
  'overall.weak.hookRate': { en: 'Weak early attention', ko: '영상 초반 주목 약함', 'zh-Hant': '前段注意力弱' },
  'overall.weak.holdRate': { en: 'Weak watch-through', ko: '끝까지 시청 약함', 'zh-Hant': '完整觀看弱' },
  'overall.weak.ctr': { en: 'Weak click response', ko: '클릭 반응 약함', 'zh-Hant': '點擊反應弱' },
  'overall.weak.cpc': { en: 'High cost per click', ko: '클릭당 비용 높음', 'zh-Hant': '每次點擊成本高' },
  'overall.weak.engagementRate': { en: 'Low engagement response', ko: '참여 반응 낮음', 'zh-Hant': '互動反應低' },
  'overall.weak.cpe': { en: 'High cost per engagement', ko: '참여당 비용 높음', 'zh-Hant': '每次互動成本高' },
  'overall.weak.cpa': { en: 'High cost per result', ko: '결과당 비용 높음', 'zh-Hant': '每個成果成本高' },
  'overall.clause.strong.cpm': { en: 'reach was generated efficiently', ko: '도달은 효율적으로 확보됐고', 'zh-Hant': '觸及取得有效率' },
  'overall.clause.strong.hookRate': { en: 'early attention was strong', ko: '초반 주목은 강했고', 'zh-Hant': '前段注意力強' },
  'overall.clause.strong.holdRate': { en: 'viewers kept watching', ko: '시청자가 끝까지 봤고', 'zh-Hant': '觀眾持續觀看' },
  'overall.clause.strong.ctr': { en: 'click response was strong', ko: '클릭 반응은 강했고', 'zh-Hant': '點擊反應強' },
  'overall.clause.strong.cpc': { en: 'clicks were bought efficiently', ko: '클릭은 효율적으로 확보됐고', 'zh-Hant': '點擊取得有效率' },
  'overall.clause.strong.engagementRate': { en: 'engagement response was strong', ko: '참여 반응은 강했고', 'zh-Hant': '互動反應強' },
  'overall.clause.strong.cpe': { en: 'engagement was bought efficiently', ko: '참여는 효율적으로 확보됐고', 'zh-Hant': '互動取得有效率' },
  'overall.clause.strong.cpa': { en: 'results were generated efficiently', ko: '결과는 효율적으로 확보됐고', 'zh-Hant': '成果取得有效率' },
  'overall.clause.weak.cpm': { en: 'reach was costly', ko: '도달 비용은 높았습니다', 'zh-Hant': '觸及成本偏高' },
  'overall.clause.weak.hookRate': { en: 'early attention was weak', ko: '초반 주목은 약했습니다', 'zh-Hant': '前段注意力弱' },
  'overall.clause.weak.holdRate': { en: 'viewers dropped off quickly', ko: '시청자는 금방 이탈했습니다', 'zh-Hant': '觀眾很快流失' },
  'overall.clause.weak.ctr': { en: 'click response was weak', ko: '클릭 반응은 약했습니다', 'zh-Hant': '點擊反應弱' },
  'overall.clause.weak.cpc': { en: 'each click was costly', ko: '클릭당 비용은 높았습니다', 'zh-Hant': '每次點擊成本偏高' },
  'overall.clause.weak.engagementRate': { en: 'engagement remained limited', ko: '참여는 제한적이었습니다', 'zh-Hant': '互動仍然有限' },
  'overall.clause.weak.cpe': { en: 'each engagement was costly', ko: '참여당 비용은 높았습니다', 'zh-Hant': '每次互動成本偏高' },
  'overall.clause.weak.cpa': { en: 'each result was costly', ko: '결과당 비용은 높았습니다', 'zh-Hant': '每個成果成本偏高' },
  'overall.reason.both': { en: '{strong}, while {weak}.', ko: '{strong} {weak}.', 'zh-Hant': '{strong}，但{weak}。' },
  'overall.reason.strongOnly': { en: '{strong}, with no weak signal among the metrics that matter for {goal} campaigns.', ko: '{strong} {goal} 캠페인에서 중요한 지표 중 약한 신호는 없었습니다.', 'zh-Hant': '{strong}，且 {goal} 廣告的重要指標中沒有弱訊號。' },
  'overall.reason.weakOnly': { en: '{weak}; nothing else stood out among the metrics that matter for {goal} campaigns.', ko: '{weak}. {goal} 캠페인에서 중요한 다른 지표는 두드러지지 않았습니다.', 'zh-Hant': '{weak}；{goal} 廣告的其他重要指標並不突出。' },
  'overall.reason.flat': { en: 'All comparable metrics sat mid-range for {goal} campaigns.', ko: '{goal} 캠페인의 비교 가능한 지표가 모두 중간 수준이었습니다.', 'zh-Hant': '{goal} 廣告的可比指標皆處於中段。' },
  'overall.reason.insufficient': { en: 'Not enough comparable past campaigns to rate the primary metrics.', ko: '대표 지표를 평가할 만큼 비교 캠페인이 없습니다.', 'zh-Hant': '可比的過往廣告不足以評估主要指標。' },
  'overall.none': { en: 'No clear strength', ko: '뚜렷한 강점 없음', 'zh-Hant': '無明顯優點' },
  'overall.noneWeak': { en: 'No clear weakness', ko: '뚜렷한 약점 없음', 'zh-Hant': '無明顯弱點' },
  ...
  // 판정
  'verdict.good': { en: 'Strong', ko: '강함', 'zh-Hant': '強' },
  'verdict.mid': { en: 'Average', ko: '보통', 'zh-Hant': '普通' },
  'verdict.bad': { en: 'Weak', ko: '약함', 'zh-Hant': '弱' },
  ...
  'recap.edit.verdict': { en: 'Overall performance', ko: '종합 성과', 'zh-Hant': '整體表現' },
