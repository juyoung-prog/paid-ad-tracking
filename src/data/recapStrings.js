...
export const RECAP_STRINGS = Object.freeze({
  ...
  'recap.table.perfBody': { en: 'A goal-aware summary of how this campaign is performing based on its current metrics.', ko: '이 캠페인의 현재 지표만으로 목표에 맞게 종합한 판정입니다.', 'zh-Hant': '依廣告目標，僅以此廣告的現行指標綜合出的判定。' },
  'recap.table.perfBody2': { en: 'The campaign goal determines which metrics matter most. Primary goal metrics drive the verdict, while relevant Video, Engagement, and Action metrics help explain strengths or weaknesses.', ko: '캠페인 목표가 어떤 지표가 중요한지 정합니다. 대표 목표 지표가 판정을 만들고, 관련 Video·Engagement·Action 지표는 강점·약점을 설명합니다.', 'zh-Hant': '廣告目標決定哪些指標最重要。主要目標指標決定判定，相關的 Video、Engagement、Action 指標用來說明強弱。' },
  'recap.table.perfBody3': { en: 'Target comparison and historical comparison are evaluated separately.', ko: '목표치 비교와 과거 비교는 따로 평가합니다.', 'zh-Hant': '目標比較與歷史比較分別評估。' },
  'recap.table.perfRule': { en: 'Rule: this campaign\'s current {primary} → healthy Good · middling Fair · poor Weak{important}. Current metrics only — no target and no past campaigns are involved.', ko: '규칙: 이 캠페인의 현재 {primary} → 건강하면 Good · 중간이면 Fair · 나쁘면 Weak{important}. 현재 지표만 쓰고 목표치·과거 캠페인은 관여하지 않습니다.', 'zh-Hant': '規則：此廣告目前的 {primary} → 健康 Good · 中等 Fair · 不佳 Weak{important}。僅用現行指標，不涉及目標或過往廣告。' },
  ...
  'recap.table.perfNotEnough': { en: 'Not enough data', ko: '데이터 부족', 'zh-Hant': '資料不足' },
  'recap.table.perfNoStandard': { en: 'Not scored for CPA-based goals yet', ko: 'CPA 계열 목표는 아직 판정하지 않음', 'zh-Hant': 'CPA 類目標尚未評分' },
  'recap.table.perfNotEnoughHint': { en: 'No overall verdict — this campaign\'s own current metrics are not enough for a reliable goal-aware assessment. Target and past comparisons play no part in this.', ko: '종합 판정 없음 — 이 캠페인의 현재 지표만으로는 목표에 맞는 판정을 내리기에 부족합니다. 목표치·과거 비교와는 무관합니다.', 'zh-Hant': '無整體判定——此廣告自身的現行指標不足以做出可靠的目標判定。與目標或歷史比較無關。' },
  'recap.table.perfNoScaleHint': { en: 'No overall verdict — CPA-based goals are not scored yet because there is no health scale for CPA. Current metrics are shown as-is.', ko: '종합 판정 없음 — CPA에는 건강 척도가 없어 CPA 계열 목표는 아직 판정하지 않습니다. 현재 지표는 그대로 보입니다.', 'zh-Hant': '無整體判定——CPA 尚無健康量尺，CPA 類目標暫不評分。現值照常顯示。' },
  'recap.table.perfWritten': { en: 'Rated by a person in Edit.', ko: 'Edit에서 사람이 고른 판정입니다.', 'zh-Hant': '由人員在編輯中評定。' },
  'perf.primary.cpm.top': { en: 'Efficient cost', ko: '비용 효율적', 'zh-Hant': '成本佳' },
  'perf.primary.cpm.mid': { en: 'Fair cost', ko: '비용 보통', 'zh-Hant': '成本中等' },
  'perf.primary.cpm.bottom': { en: 'High cost', ko: '비용 높음', 'zh-Hant': '成本高' },
  'perf.primary.cpc.top': { en: 'Efficient cost', ko: '비용 효율적', 'zh-Hant': '成本佳' },
  'perf.primary.cpc.mid': { en: 'Fair cost', ko: '비용 보통', 'zh-Hant': '成本中等' },
  'perf.primary.cpc.bottom': { en: 'High cost', ko: '비용 높음', 'zh-Hant': '成本高' },
  'perf.primary.cpe.top': { en: 'Efficient cost', ko: '비용 효율적', 'zh-Hant': '成本佳' },
  'perf.primary.cpe.mid': { en: 'Fair cost', ko: '비용 보통', 'zh-Hant': '成本中等' },
  'perf.primary.cpe.bottom': { en: 'High cost', ko: '비용 높음', 'zh-Hant': '成本高' },
  'perf.primary.cpa.top': { en: 'Efficient cost', ko: '비용 효율적', 'zh-Hant': '成本佳' },
  'perf.primary.cpa.mid': { en: 'Fair cost', ko: '비용 보통', 'zh-Hant': '成本中等' },
  'perf.primary.cpa.bottom': { en: 'High cost', ko: '비용 높음', 'zh-Hant': '成本高' },
