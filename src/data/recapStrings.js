...
export const RECAP_STRINGS = Object.freeze({
  ...
  'recap.table.effBody': { en: 'Measures the campaign\'s goal-specific cost KPI against the median of comparable past campaigns.', ko: '캠페인 목표의 결과당 비용을 비교 가능한 과거 캠페인의 중앙값과 견줍니다.', 'zh-Hant': '以廣告目標的成果成本對比可比過往廣告的中位數。' },
  ...
  'recap.table.effBands': { en: 'Good ≤80% · Fair 80–120% · Weak >120%', ko: 'Good 80% 이하 · Fair 80~120% · Weak 120% 초과', 'zh-Hant': 'Good ≤80% · Fair 80–120% · Weak >120%' },
  'recap.table.effRanking': { en: 'The ranking below uses the same comparison group.', ko: '아래 순위도 같은 비교군을 씁니다.', 'zh-Hant': '下方排名採用同一比較組。' },
  'recap.table.vsPast': { en: 'vs past', ko: '과거 대비', 'zh-Hant': '對比過往' },
  'recap.table.standardHint': { en: 'Budget efficiency: {metric} {value} vs median {median} of {n} comparable {platform} {goal} campaigns from other events ({pct}% of median). The ranking below places this campaign among those {n} plus itself ({total} in all).', ko: '예산 효율: {metric} {value}, 다른 이벤트의 비교 가능한 {platform} {goal} 캠페인 {n}개 중앙값 {median} 대비 {pct}%. 아래 순위는 그 {n}개에 이 캠페인을 더한 {total}개 안의 위치입니다.', 'zh-Hant': '預算效率：{metric} {value}，為其他活動 {n} 支可比 {platform} {goal} 廣告中位數 {median} 的 {pct}%。下方排名為此廣告在該 {n} 支加自身共 {total} 支中的位置。' },
