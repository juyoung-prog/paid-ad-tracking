...
export const RECAP_STRINGS = Object.freeze({
  ...
  'recap.table.verdict': { en: 'Cost efficiency', ko: '비용 효율', 'zh-Hant': '成本效率' },
  'recap.table.performance': { en: 'Performance', ko: '종합 성과', 'zh-Hant': '整體表現' },
  'recap.table.perfTitle': { en: 'Overall performance', ko: '종합 성과', 'zh-Hant': '整體表現' },
  'recap.table.perfBody': { en: 'A goal-aware summary of how the campaign performed across its most relevant metrics.', ko: '캠페인 목표에 맞는 지표들을 종합한 한 단어 판정입니다.', 'zh-Hant': '依廣告目標，綜合最相關指標的整體判定。' },
  'recap.table.perfBody2': { en: 'The primary metrics depend on the campaign goal and are judged against our own reference ranges (our campaigns since 2024). Supporting Video, Engagement, and Action metrics are used as diagnostics when relevant.', ko: '대표 지표는 목표에 따라 다르고, 이 캠페인의 현재 값을 우리 기준 범위(2024년 이후 우리 캠페인)에 댑니다. Video·Engagement·Action 지표는 관련 있을 때만 진단에 씁니다.', 'zh-Hant': '主要指標依目標而定，並以此廣告的現值對比我們自己的參考範圍（2024 年起的廣告）。Video、Engagement、Action 指標僅在相關時作為診斷。' },
  'recap.table.perfBody3': { en: 'Cost efficiency, target comparison, and historical ranking are shown separately so the verdict remains explainable.', ko: '비용 효율·목표치 비교·과거 순위는 따로 보여줘 판정의 근거를 추적할 수 있게 합니다.', 'zh-Hant': '成本效率、目標比較與歷史排名分別顯示，讓判定可被追溯。' },
  'recap.table.perfRule': { en: 'Rule: this campaign\'s {primary} vs our reference range → top quarter Good · middle Fair · bottom quarter Weak{important}. Current values only — past campaigns are not used.', ko: '규칙: 이 캠페인의 {primary}을(를) 우리 기준 범위에 대어 상위 25% Good · 중간 Fair · 하위 25% Weak{important}. 현재 값만 쓰고 과거 캠페인은 쓰지 않습니다.', 'zh-Hant': '規則：此廣告的 {primary} 對比我們的參考範圍 → 前 25% Good · 中段 Fair · 後 25% Weak{important}。僅用現值，不使用過往廣告。' },
  'recap.table.perfRuleImportant': { en: '; a weak {important} lowers Good to Fair', ko: '; {important}이(가) 하위면 Good → Fair', 'zh-Hant': '；{important} 落後時 Good 降為 Fair' },
  'recap.table.perfNotEnough': { en: 'No performance data', ko: '성과 데이터 없음', 'zh-Hant': '無成效資料' },
  'recap.table.perfNoStandard': { en: 'No reference range for this goal yet', ko: '이 목표의 기준 범위가 아직 없음', 'zh-Hant': '此目標尚無參考範圍' },
  'recap.table.perfNotEnoughHint': { en: 'No overall verdict — this goal\'s primary metrics have no reference range yet (needs CPA history). Current metrics are shown as-is.', ko: '종합 판정 없음 — 이 목표의 대표 지표에 아직 기준 범위가 없습니다(CPA 이력 필요). 현재 지표는 그대로 보입니다.', 'zh-Hant': '無整體判定——此目標的主要指標尚無參考範圍（需 CPA 歷史）。現值照常顯示。' },
  'recap.table.perfWritten': { en: 'Rated by a person in Edit.', ko: 'Edit에서 사람이 고른 판정입니다.', 'zh-Hant': '由人員在編輯中評定。' },
  'perf.primary.cpm.top': { en: 'Efficient reach cost', ko: '도달 비용 효율적', 'zh-Hant': '觸及成本佳' },
  'perf.primary.cpm.mid': { en: 'Fair reach cost', ko: '도달 비용 보통', 'zh-Hant': '觸及成本中等' },
  'perf.primary.cpm.bottom': { en: 'High reach cost', ko: '도달 비용 높음', 'zh-Hant': '觸及成本高' },
  'perf.primary.cpc.top': { en: 'Efficient click cost', ko: '클릭 비용 효율적', 'zh-Hant': '點擊成本佳' },
  'perf.primary.cpc.mid': { en: 'Fair click cost', ko: '클릭 비용 보통', 'zh-Hant': '點擊成本中等' },
  'perf.primary.cpc.bottom': { en: 'High click cost', ko: '클릭 비용 높음', 'zh-Hant': '點擊成本高' },
  'perf.primary.cpe.top': { en: 'Efficient engagement cost', ko: '참여 비용 효율적', 'zh-Hant': '互動成本佳' },
  'perf.primary.cpe.mid': { en: 'Fair engagement cost', ko: '참여 비용 보통', 'zh-Hant': '互動成本中等' },
  'perf.primary.cpe.bottom': { en: 'High engagement cost', ko: '참여 비용 높음', 'zh-Hant': '互動成本高' },
  'perf.primary.cpa.top': { en: 'Efficient result cost', ko: '결과 비용 효율적', 'zh-Hant': '成果成本佳' },
  'perf.primary.cpa.mid': { en: 'Fair result cost', ko: '결과 비용 보통', 'zh-Hant': '成果成本中等' },
  'perf.primary.cpa.bottom': { en: 'High result cost', ko: '결과 비용 높음', 'zh-Hant': '成果成本高' },
  'perf.primary.ctr.top': { en: 'Strong click rate', ko: '클릭률 강함', 'zh-Hant': '點擊率強' },
  'perf.primary.ctr.mid': { en: 'Fair click rate', ko: '클릭률 보통', 'zh-Hant': '點擊率中等' },
  'perf.primary.ctr.bottom': { en: 'Weak click rate', ko: '클릭률 약함', 'zh-Hant': '點擊率弱' },
  'perf.primary.engagementRate.top': { en: 'Strong engagement', ko: '참여 강함', 'zh-Hant': '互動強' },
  'perf.primary.engagementRate.mid': { en: 'Fair engagement', ko: '참여 보통', 'zh-Hant': '互動中等' },
  'perf.primary.engagementRate.bottom': { en: 'Weak engagement', ko: '참여 약함', 'zh-Hant': '互動弱' },
  'perf.diag.strong': { en: 'strong {x}', ko: '{x} 강함', 'zh-Hant': '{x}強' },
  'perf.diag.weak': { en: 'weak {x}', ko: '{x} 약함', 'zh-Hant': '{x}弱' },
  ...
  'recap.table.effTitle': { en: 'Cost efficiency', ko: '비용 효율', 'zh-Hant': '成本效率' },
  'recap.table.effBody': { en: 'Shows how much this campaign spent per relevant result, based on its goal.', ko: '이 캠페인이 목표에 맞는 결과 하나에 얼마를 썼는지 보여줍니다.', 'zh-Hant': '顯示此廣告依其目標，每個相關成果的花費。' },
  'recap.table.effGoals': { en: 'Awareness → CPM · Traffic → CPC · Engagement → Cost/eng · CPA-based goals → CPA', ko: '인지 → CPM · 트래픽 → CPC · 참여 → Cost/eng · 전환 계열 → CPA', 'zh-Hant': '認知 → CPM · 流量 → CPC · 互動 → Cost/eng · 轉換類 → CPA' },
  'recap.table.effRanking': { en: 'Target and historical comparisons are shown separately.', ko: '목표치·과거 비교는 따로 보여줍니다.', 'zh-Hant': '目標與歷史比較分別顯示。' },
  ...
  'recap.table.effValueHint': { en: '{metric} = spend ÷ {basis} for this campaign only. Past campaigns do not affect this value.', ko: '{metric} = 이 캠페인의 지출 ÷ {basis}. 과거 캠페인은 이 값에 영향을 주지 않습니다.', 'zh-Hant': '{metric} = 此廣告的花費 ÷ {basis}。過往廣告不影響此值。' },
  'recap.table.effBasis.cpm': { en: 'impressions × 1,000', ko: '노출 × 1,000', 'zh-Hant': '曝光 × 1,000' },
  'recap.table.effBasis.cpc': { en: 'clicks', ko: '클릭', 'zh-Hant': '點擊' },
  'recap.table.effBasis.cpe': { en: '(likes + comments + shares)', ko: '(좋아요 + 댓글 + 공유)', 'zh-Hant': '（按讚 + 留言 + 分享）' },
  'recap.table.effBasis.cpa': { en: 'results', ko: '결과', 'zh-Hant': '成果' },
  ...
  'insight.why.reachNotAction': { en: 'Insufficient evidence', ko: '근거 부족', 'zh-Hant': '證據不足' },
  'insight.why.reachNotAction.evidence': { en: 'Available metrics do not identify the cause', ko: '지표만으로는 원인을 알 수 없음', 'zh-Hant': '現有指標無法判斷原因' },
  'insight.why.actionNotReach': { en: 'Insufficient evidence', ko: '근거 부족', 'zh-Hant': '證據不足' },
  'insight.why.actionNotReach.evidence': { en: 'Available metrics do not identify the cause', ko: '지표만으로는 원인을 알 수 없음', 'zh-Hant': '現有指標無法判斷原因' },
  'insight.why.hookNotHold': { en: 'Insufficient evidence', ko: '근거 부족', 'zh-Hant': '證據不足' },
  'insight.why.hookNotHold.evidence': { en: 'Available metrics do not identify the cause', ko: '지표만으로는 원인을 알 수 없음', 'zh-Hant': '現有指標無法判斷原因' },
  'insight.why.holdNotHook': { en: 'Insufficient evidence', ko: '근거 부족', 'zh-Hant': '證據不足' },
  'insight.why.holdNotHook.evidence': { en: 'Available metrics do not identify the cause', ko: '지표만으로는 원인을 알 수 없음', 'zh-Hant': '現有指標無法判斷原因' },
  'insight.why.allStrong': { en: 'Insufficient evidence', ko: '근거 부족', 'zh-Hant': '證據不足' },
  'insight.why.allStrong.evidence': { en: 'Available metrics do not identify the cause', ko: '지표만으로는 원인을 알 수 없음', 'zh-Hant': '現有指標無法判斷原因' },
  'insight.why.allWeak': { en: 'Insufficient evidence', ko: '근거 부족', 'zh-Hant': '證據不足' },
  'insight.why.allWeak.evidence': { en: 'Available metrics do not identify the cause', ko: '지표만으로는 원인을 알 수 없음', 'zh-Hant': '現有指標無法判斷原因' },
  ...
  'insight.next.keepAndTest': { en: 'Improve {test} without losing {keep} performance', ko: '{keep} 성과를 잃지 않고 {test} 개선', 'zh-Hant': '在不損失{keep}表現的前提下改善{test}' },
  'insight.next.keepAndTest.evidence': { en: 'Test changes in the next comparable campaign', ko: '다음 비교 캠페인에서 변경을 시험', 'zh-Hant': '在下一支可比廣告中測試變更' },
  'insight.next.keepAndBudget': { en: 'Hold {keep} performance within budget', ko: '예산 안에서 {keep} 성과 유지', 'zh-Hant': '在預算內維持{keep}表現' },
  'insight.next.keepAndBudget.evidence': { en: 'Set the next daily budget for the {pct}% overspend', ko: '다음 일예산은 {pct}% 초과를 감안', 'zh-Hant': '下次每日預算考量 {pct}% 超支' },
  'insight.next.repeat': { en: 'Repeat and confirm {aspectShort} performance', ko: '{aspect} 성과 반복 확인', 'zh-Hant': '重複並確認{aspect}表現' },
  'insight.next.repeat.evidence': { en: 'Check whether {metric} holds in the next comparable campaign', ko: '다음 비교 캠페인에서 {metric} 유지 여부 확인', 'zh-Hant': '確認下一支可比廣告的 {metric} 是否維持' },
  'insight.next.improve': { en: 'Improve {aspect}', ko: '{aspect} 개선', 'zh-Hant': '改善{aspect}' },
  'insight.next.improve.evidence': { en: 'Beat this {metric} in the next comparable campaign', ko: '다음 비교 캠페인에서 이 {metric}를 넘기', 'zh-Hant': '在下一支可比廣告中超越此 {metric}' },
  ...
  'play.keep.platformReach': { en: 'Efficient reach', ko: '효율적인 도달', 'zh-Hant': '觸及有效率' },
  'play.keep.platformReach.why': { en: '{platform} produced the lower CPM in this event', ko: '이번 이벤트에서는 {platform}의 CPM이 더 낮았음', 'zh-Hant': '本次活動 {platform} 的 CPM 較低' },
  'play.keep.platformBoth': { en: 'Efficient reach and clicks', ko: '효율적인 도달과 클릭', 'zh-Hant': '觸及與點擊皆有效率' },
  'play.keep.platformBoth.why': { en: '{platform} produced the lower CPM and higher CTR in this event', ko: '이번 이벤트에서는 {platform}의 CPM이 낮고 CTR이 높았음', 'zh-Hant': '本次活動 {platform} 的 CPM 較低且 CTR 較高' },
  ...
  'play.keep.strong': { en: 'Efficient {aspectLower}', ko: '효율적인 {aspect}', 'zh-Hant': '{aspect}有效率' },
  ...
  'play.use.platformClicks': { en: '{platform} for traffic', ko: '트래픽은 {platform}', 'zh-Hant': '流量用 {platform}' },
  'play.use.platformClicks.why': { en: 'Higher CTR appeared in this event', ko: '이번 이벤트에서는 CTR이 더 높았음', 'zh-Hant': '本次活動出現較高的 CTR' },
  'play.use.platformOther': { en: '{platform} as a secondary channel', ko: '{platform}은 보조 채널로', 'zh-Hant': '{platform} 作為次要管道' },
  'play.use.platformOther.why': { en: 'Higher CPM and lower CTR appeared in this event', ko: '이번 이벤트에서는 CPM이 높고 CTR이 낮았음', 'zh-Hant': '本次活動出現較高的 CPM 與較低的 CTR' },
  ...
  'play.improve.weak': { en: '{aspect}', ko: '{aspect}', 'zh-Hant': '{aspect}' },
  'play.improve.weak.why': { en: '{metric} performance was weaker across multiple campaigns', ko: '여러 캠페인에서 {metric} 성과가 약했음', 'zh-Hant': '多支廣告的 {metric} 表現較弱' },
  'play.validate.mixed': { en: '{aspect}', ko: '{aspect}', 'zh-Hant': '{aspect}' },
  ...
  'play.validate.uncovered': { en: '{aspect}', ko: '{aspect}', 'zh-Hant': '{aspect}' },
  'play.validate.uncovered.why': { en: 'No consistent pattern across campaigns', ko: '캠페인들에 걸쳐 일관된 패턴 없음', 'zh-Hant': '各廣告間無一致模式' },
  'play.next.title': { en: 'Next event', ko: '다음 이벤트', 'zh-Hant': '下次活動' },
  'play.next.split': { en: 'Use these event results as the starting hypothesis, then validate CPM, CTR{aspects} while campaigns are running.', ko: '이번 이벤트 결과를 출발 가설로 삼고, 집행 중에 CPM, CTR{aspects}을 검증한다.', 'zh-Hant': '以本次活動結果為起始假設，並在投放期間驗證 CPM、CTR{aspects}。' },
  'play.next.lean': { en: 'Use these event results as the starting hypothesis, then validate CPM, CTR{aspects} while campaigns are running.', ko: '이번 이벤트 결과를 출발 가설로 삼고, 집행 중에 CPM, CTR{aspects}을 검증한다.', 'zh-Hant': '以本次活動結果為起始假設，並在投放期間驗證 CPM、CTR{aspects}。' },
  'play.next.phase': { en: 'Use these event results as the starting hypothesis, then validate CPM, CTR{aspects} while campaigns are running.', ko: '이번 이벤트 결과를 출발 가설로 삼고, 집행 중에 CPM, CTR{aspects}을 검증한다.', 'zh-Hant': '以本次活動結果為起始假設，並在投放期間驗證 CPM、CTR{aspects}。' },
  ...
  'recap.edit.noSuggestion': { en: 'No automatic rating — the table shows the cost per result; rate it here if you want a verdict on record.', ko: '자동 판정은 없습니다 — 표는 결과당 비용을 보여주고, 판정을 남기려면 여기서 고르세요.', 'zh-Hant': '沒有自動評定——表格顯示成果成本；若要留下評定請在此選擇。' },
