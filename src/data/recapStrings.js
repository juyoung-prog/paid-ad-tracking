...
export const RECAP_STRINGS = Object.freeze({
  ...
  'recap.table.effBody': { en: 'Measures cost per result against our historical standard for the campaign goal.', ko: '캠페인 목표의 결과당 비용을 우리 과거 기준과 견줍니다.', 'zh-Hant': '以廣告目標的成果成本對比我們的歷史基準。' },
  ...
  'recap.table.effRanking': { en: 'The ranking below compares this campaign with similar past campaigns.', ko: '아래 순위는 이 캠페인을 비슷한 과거 캠페인과 비교한 것입니다.', 'zh-Hant': '下方排名為此廣告與相似過往廣告的比較。' },
