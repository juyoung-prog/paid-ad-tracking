...
export const RECAP_STRINGS = Object.freeze({
  ...
  'recap.table.costEfficiency': { en: 'Cost efficiency', ko: '비용 효율', 'zh-Hant': '成本效率' },
  'recap.table.goalResult': { en: 'Goal result', ko: '목표 결과', 'zh-Hant': '目標結果' },
  'recap.table.goalResultTitle': { en: 'Goal result', ko: '목표 결과', 'zh-Hant': '目標結果' },
  'recap.table.goalResultBody': { en: 'Summarizes this campaign\'s current results using the metrics most relevant to its goal.', ko: '이 캠페인의 목표에 가장 관련 있는 지표로 현재 결과를 요약합니다.', 'zh-Hant': '以與此廣告目標最相關的指標，摘要目前的結果。' },
  'recap.table.goalResultBody2': { en: 'This is not a performance grade. Target and historical comparisons are shown separately.', ko: '성과 등급이 아닙니다. 목표치 비교와 과거 비교는 따로 보여줍니다.', 'zh-Hant': '這不是成效評分。目標比較與歷史比較另外顯示。' },
  'recap.table.goalResultClicks': { en: '{n} clicks', ko: '클릭 {n}', 'zh-Hant': '{n} 次點擊' },
  'recap.table.goalResultResults': { en: '{n} results', ko: '결과 {n}', 'zh-Hant': '{n} 個成果' },
  'recap.table.goalResultEmpty': { en: 'No current results yet for this goal\'s metrics.', ko: '이 목표의 지표에 아직 현재 값이 없습니다.', 'zh-Hant': '此目標的指標尚無現值。' },
  ...
  'recap.table.vsPastHint': { en: 'Rank of this campaign\'s cost KPI among comparable past campaigns from other events. Historical data is used here only.', ko: '이 캠페인의 비용 KPI가 다른 이벤트의 비슷한 과거 캠페인 사이에서 몇 번째인지. 과거 데이터는 여기에서만 씁니다.', 'zh-Hant': '此廣告的成本 KPI 在其他活動的可比過往廣告中的排名。歷史資料僅用於此處。' },
