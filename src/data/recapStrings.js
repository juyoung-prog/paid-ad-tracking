...
export const RECAP_STRINGS = Object.freeze({
  ...
  'recap.exec.next.platformEvidence': { en: '{pct}% lower CPM than {pricier} in this event', ko: '이번 이벤트에서 {pricier}보다 CPM {pct}% 낮음', 'zh-Hant': '本次活動 CPM 較 {pricier} 低 {pct}%' },
  ...
  'recap.exec.next.reviewWeak': { en: 'Review {platform} {phase} before reuse', ko: '{platform} {phase}는 재사용 전 점검', 'zh-Hant': '重複使用 {platform} {phase} 前先檢視' },
