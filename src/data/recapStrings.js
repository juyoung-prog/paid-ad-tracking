...
export const RECAP_STRINGS = Object.freeze({
  ...
  'insight.why.reachNotAction.evidence': { en: 'Strong CPM but weak clicks — no causal signal in metrics', ko: 'CPM은 좋고 클릭은 약함 — 지표에 원인 신호 없음', 'zh-Hant': 'CPM 佳但點擊弱——指標中無因果訊號' },
  'insight.why.actionNotReach': { en: 'Insufficient evidence', ko: '근거 부족', 'zh-Hant': '證據不足' },
  'insight.why.actionNotReach.evidence': { en: 'High CPM but strong clicks — no causal signal in metrics', ko: 'CPM은 높고 클릭은 강함 — 지표에 원인 신호 없음', 'zh-Hant': 'CPM 高但點擊強——指標中無因果訊號' },
  'insight.why.hookNotHold': { en: 'Insufficient evidence', ko: '근거 부족', 'zh-Hant': '證據不足' },
  'insight.why.hookNotHold.evidence': { en: 'Strong hook but weak hold — no causal signal in metrics', ko: 'Hook 강, Hold 약 — 지표에 원인 신호 없음', 'zh-Hant': 'Hook 強但 Hold 弱——指標中無因果訊號' },
  'insight.why.holdNotHook': { en: 'Insufficient evidence', ko: '근거 부족', 'zh-Hant': '證據不足' },
  'insight.why.holdNotHook.evidence': { en: 'Weak hook but strong hold — no causal signal in metrics', ko: 'Hook 약, Hold 강 — 지표에 원인 신호 없음', 'zh-Hant': 'Hook 弱但 Hold 強——指標中無因果訊號' },
  'insight.why.allStrong': { en: 'Insufficient evidence', ko: '근거 부족', 'zh-Hant': '證據不足' },
  'insight.why.allStrong.evidence': { en: 'Top band on every comparable metric — no causal signal in metrics', ko: '비교 가능한 지표 모두 상위 — 지표에 원인 신호 없음', 'zh-Hant': '所有可比指標皆前段——指標中無因果訊號' },
  'insight.why.allWeak': { en: 'Insufficient evidence', ko: '근거 부족', 'zh-Hant': '證據不足' },
  'insight.why.allWeak.evidence': { en: 'Bottom band on every comparable metric — no causal signal in metrics', ko: '비교 가능한 지표 모두 하위 — 지표에 원인 신호 없음', 'zh-Hant': '所有可比指標皆後段——指標中無因果訊號' },
  ...
  'insight.next.repeat.evidence': { en: 'Check {metric} holds in the next comparable campaign', ko: '다음 비교 캠페인에서 {metric} 유지 여부 확인', 'zh-Hant': '確認下一支可比廣告的 {metric} 是否維持' },
