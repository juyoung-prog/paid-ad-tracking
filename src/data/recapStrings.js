...
export const RECAP_STRINGS = Object.freeze({
  ...
  'recap.table.effTitle': { en: 'Budget efficiency', ko: '예산 효율', 'zh-Hant': '預算效率' },
  ...
  'recap.table.effRanking': { en: 'Historical ranking is shown separately below and compares the campaign with similar past campaigns.', ko: '아래 과거 대비 순위는 별개로, 비슷한 과거 캠페인과 비교한 것입니다.', 'zh-Hant': '下方的歷史排名為另一層，將此廣告與相似的過往廣告比較。' },
