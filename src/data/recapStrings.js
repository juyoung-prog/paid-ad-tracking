...
export const RECAP_STRINGS = Object.freeze({
  ...
  'recap.table.perfBody2': { en: 'The primary metrics depend on the campaign goal. Supporting Video, Engagement, and Action metrics are used as diagnostics when relevant.', ko: '대표 지표는 목표에 따라 다르고, Video·Engagement·Action 지표는 관련 있을 때만 진단에 씁니다.', 'zh-Hant': '主要指標依目標而定；Video、Engagement、Action 指標僅在相關時作為診斷。' },
  ...
  'recap.table.perfRule': { en: 'Rule: {primary} vs comparable past campaigns → top band Good · mid Fair · bottom Weak{important}. No rating without at least 3 comparable campaigns.', ko: '규칙: {primary}을(를) 과거 비교군과 견줘 상위 Good · 중간 Fair · 하위 Weak{important}. 비교 캠페인 3개 미만이면 판정 없음.', 'zh-Hant': '規則：{primary} 對比可比過往廣告 → 前段 Good · 中段 Fair · 後段 Weak{important}。可比廣告不足 3 支則不評定。' },
  ...
  'recap.table.perfNotEnoughHint': { en: 'No overall verdict — fewer than 3 comparable past campaigns for this goal, so its primary metrics cannot be placed in a band.', ko: '종합 판정 없음 — 이 목표의 과거 비교 캠페인이 3개 미만이라 대표 지표의 구간을 정할 수 없습니다.', 'zh-Hant': '無整體判定——此目標的可比過往廣告少於 3 支，無法判定主要指標的區間。' },
  'recap.table.perfWritten': { en: 'Rated by a person in Edit.', ko: 'Edit에서 사람이 고른 판정입니다.', 'zh-Hant': '由人員在編輯中評定。' },
  'perf.cost.top': { en: 'Strong cost', ko: '비용 효율 좋음', 'zh-Hant': '成本佳' },
  'perf.cost.mid': { en: 'Fair cost', ko: '비용 효율 보통', 'zh-Hant': '成本中等' },
  'perf.cost.bottom': { en: 'High cost', ko: '비용 높음', 'zh-Hant': '成本高' },
  ...
  'recap.table.noComparison': { en: 'Not enough comparison data — fewer than 3 comparable past campaigns on this platform with this goal. The efficiency value above is this campaign\'s own result.', ko: '비교 데이터 부족 — 같은 플랫폼·같은 목표의 과거 비교 캠페인이 3개 미만입니다. 위의 효율 값은 이 캠페인 자체의 결과입니다.', 'zh-Hant': '比較資料不足——同平台、同目標的可比過往廣告少於 3 支。上方效率值為此廣告本身的結果。' },
