...
export const mockEventRecaps = [
  {
    ...
    status: 'draft',
    summary: {
      en: 'Grand Opening carried the event: the strongest hook rate and CPM among comparable openings. Coming Soon reached people cheaply but produced few clicks, and the store-visit phase has no comparable campaign yet, so it cannot be ranked.',
      ko: null,
      'zh-Hant': null,
    },
    learnings: [
      {
        title: { en: 'Grand Opening campaigns generated stronger click efficiency than Coming Soon campaigns in this event', ko: null, 'zh-Hant': null },
        body: { en: 'CTR and CPC were stronger for Grand Opening than for Coming Soon on both platforms. This describes the measured pattern; the data does not say which message or creative drove it.', ko: null, 'zh-Hant': null },
      },
      {
        title: { en: 'For this event, TikTok delivered cheaper reach while Meta delivered stronger click efficiency', ko: null, 'zh-Hant': null },
        body: { en: 'Event-level CPM was lower on TikTok and CTR higher on Meta by more than 15% each. This is one event\'s result, not a rule about the platforms.', ko: null, 'zh-Hant': null },
      },
    ],
    nextSteps: { en: 'Given the stronger click efficiency of the Grand Opening phase, consider allocating a larger share of the next opening budget toward that phase, and treat Coming Soon as a reach phase measured on CPM rather than clicks.', ko: null, 'zh-Hant': null },
...
export const mockRecapCampaignNotes = [
  ...
  },
  {
    ...
    verdict: null,
    strength: { en: 'Cheapest reach of the event — CPM in the top band among comparable Meta Coming Soon campaigns.', ko: null, 'zh-Hant': null },
    weakness: { en: 'Very few clicks relative to reach — CTR among the lowest of comparable campaigns.', ko: null, 'zh-Hant': null },
    reason: null,
    organicViews: null,
    organicEngagements: null,
  },
  {
    ...
    verdict: 'bad',
    strength: null,
    weakness: { en: 'Low hook rate for the spend compared with the other TikTok campaigns in this event.', ko: null, 'zh-Hant': null },
    reason: { en: 'Not enough evidence to determine why — there are too few comparable TikTok campaigns to rank it, and the data does not describe the creative.', ko: null, 'zh-Hant': null },
    organicViews: null,
    organicEngagements: null,
  },
];
