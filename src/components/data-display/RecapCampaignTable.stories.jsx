...
- **Engagement / Action**: 대표 두 자리는 목표가 정한다 — 인지 참여율·CTR · 트래픽 CTR·CPC · 참여 참여율·Cost/eng · 전환 CPA·CTR. 그 아래는 목표와 무관하게 **참여 내역 4열 미니 그리드** — 첫 줄 Like · Cmt · Share · Save, 넘치면 둘째 줄에 같은 열로(Meta는 Repost, TikTok은 Follow · Visits. 한 줄에 다섯 이상 늘어놓지 않는다, 2026-09-12).(값 없는 항목은 뺀다 — 2026-09-11. 인플루언서 시트와 같은 일곱 값 없는 항목은 뺀다 — 2026-09-11. 인플루언서 시트와 같은 일곱 가지를 드로어·Performance·Reports가 같은 목록으로 본다. Save는 Meta만(post_save), Repost는 두 광고 API에 없어 수기 레코드만). 원본 값은 전부 행에 남아 있다
