...
- **Efficiency** 두 줄: 위 배지 = 예산 효율(목표별 대표 KPI 결과당 비용 vs 우리 기준값 EFFICIENCY_STANDARD, 툴팁에 값·기준값·비율), 아래 "vs past" = 같은 KPI의 과거 비교군 순위(3개 미만이면 not enough data). 사람이 고른 판정이 있으면 배지는 그것을
