...
- 글자: 화면 위계 그대로 한 단씩 pt로(13 → 8pt · 12 → 7.5pt · 11 → 6.5pt). 네 줄 자르기는 풀어 전문을 찍는다
- 해석 두 열(What worked · Could improve)은 그 폭에서 문장이 설 자리가 없어 **같은 캠페인의 둘째 줄로 접힌다** —
  열을 지우는 게 아니라 줄바꿈이고, 값은 위 줄과 같은 \`insightCells\`에서 온다(편집 중에도 읽기 문장을 찍는다).
  지표 줄과 접힌 줄 사이 경계선은 지우고 둘을 함께 페이지에 붙여 둔다
