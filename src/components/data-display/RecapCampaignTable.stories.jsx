...
- **Engagement / Action**: 대표 두 자리는 목표가 정한다 — 인지 참여율·CTR · 트래픽 CTR·CPC · 참여 참여율·Cost/eng · 전환 CPA·CTR. 그 아래 보조 줄은 목표와 무관하게 **참여 내역** "Like 508 · Cmt 10 · Share 601"(TikTok은 · Follow · Profile까지, 값 없는 항목은 뺀다 — 2026-09-11. 전에는 목표별 수량이라 댓글이 어디에도 안 보였다. Save·Repost는 광고 API가 캠페인 단위로 주지 않아 없다). 원본 값은 전부 행에 남아 있다
