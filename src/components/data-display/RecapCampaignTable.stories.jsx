...
- **Engagement / Action**: 대표 두 자리는 목표가 정한다 — 인지 참여율·CTR · 트래픽 CTR·CPC · 참여 참여율·Cost/eng · 전환 CPA·CTR. 그 아래 보조 줄은 목표와 무관하게 **참여 내역** "Like 508 · Cmt 10 · Share 601 · Save 183"(TikTok은 · Follow · Visits까지. 값 없는 항목은 뺀다 — 2026-09-11. 인플루언서 시트와 같은 일곱 가지를 드로어·Performance·Reports가 같은 목록으로 본다. Save는 Meta만(post_save), Repost는 두 광고 API에 없어 수기 레코드만). 원본 값은 전부 행에 남아 있다
