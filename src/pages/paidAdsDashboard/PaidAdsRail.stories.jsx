...
- Dashboard / Performance / Reports / Stores 는 1급 내비, **Settings는 하단 유틸리티**로 분리했다. 이름 체계(2026-09): Dashboard = 지금 무슨 일이, Performance(내부 /reports) = 광고가 어떻게 되고 있나, Reports(내부 /recap) = 이벤트가 끝난 뒤 무슨 일이 있었고 무엇을 배웠나. 내부 경로는 기존 링크를 지키려 바꾸지 않았다.
