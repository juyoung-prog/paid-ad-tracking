...
const recapEnums = [
  ...
  { name: 'GOAL_PERFORMANCE_RULES / buildPerformanceVerdict', value: "목표별 { primary, important, secondary } 지표 표 + 구간 규칙(primary 상위 → Good, important 하위면 Fair · 중간 → Fair · 하위 → Weak · 구간 없으면 null) — 표의 Performance 열. 가중치 점수 없음(2026-09-07)" },
];
