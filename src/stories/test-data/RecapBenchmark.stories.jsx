...
- 종합 성과(performance / suggestedVerdict) = GOAL_PERFORMANCE_RULES를 benchmarks 구간에 적용: primary 상위 → Good(important 진단 하위면 Fair) · 중간 → Fair · 하위 → Weak · primary 구간 없으면 null. 사람이 고른 note.verdict가 우선
