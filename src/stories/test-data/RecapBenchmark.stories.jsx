...
- 종합 등급은 없다(2026-09-08 제품 결정) — 표의 Primary KPI(budgetEfficiency)는 값 그대로, vs past(benchmarks)는 맥락, 등급으로 바꾸지 않는다. note.verdict는 사람이 Edit에서 고를 때만
                ...
                <TableBody>
                  {rows.map((r) => (
                    <TableRow key={r.campaignId}>
                      ...
                      <TableCell>{r.budgetEfficiency?.metricKey ?? 'null'}</TableCell>
